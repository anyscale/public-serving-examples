...
class StreamingAnalyzer:
    ...
    async def _extract_entities(self, text: str) -> List[Dict[str, Any]]:
        ...
        for entity in entities:
            if current_entity is None or entity["entity"].startswith("B-"):
                ...
                current_entity["score"] = (current_entity["score"] + float(entity["score"])) / 2
    ...
    async def stream_analysis(self, text: str, analysis_types: List[str] = ["sentiment", "entities"]) -> AsyncGenerator[Dict[str, Any], None]:
        """
    ...
    async def analyze_document(self, text: str, analysis_types: List[str] = ["sentiment", "entities"]) -> Dict[str, Any]:
        """
        ...
        if "sentiment" in analysis_types:
            ...
            sentiment_scores = [r["sentiment"]["score"] for r in all_results if "sentiment" in r]
            ...
            summary["sentiment"] = {
                ...
                "sentiment_by_chunk": [r["sentiment"]["sentiment"] for r in all_results if "sentiment" in r]
            }
