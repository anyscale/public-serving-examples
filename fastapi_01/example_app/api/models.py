...
class TextRequest(BaseModel):
    ...
    options: Dict[str, Any] = Field(default_factory=dict, description="Additional options for processing")
...
class ClassificationRequest(TextRequest):
    ...
    labels: List[str] = Field(..., min_items=1, description="Possible categories for classification")
...
class SummarizationRequest(TextRequest):
    ...
    max_length: int = Field(100, ge=10, description="Maximum length of summary in tokens")
